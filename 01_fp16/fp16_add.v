...
localparam [EXP_WIDTH-1 : 0] EXT_EXP_ZERO = {EXP_WIDTH+1{1'b0}};
...
reg [EXTRA_WIDTH-1:0] small_mant_shifted;
...
always @(*) begin
    ...
    if (addsub_zero) begin
        ...
        for (idx = 0; idx < EXTRA_WIDTH; idx = idx + 1) begin
            if ((norm_mant[EXTRA_WIDTH-1] == 1'b0) && (norm_exp > 1)) begin
